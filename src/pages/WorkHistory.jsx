    ...
    return (
        <div id="work-history">
            ...
            <div id="employers">
                ...
                <div>
                    <ul>
                        <h2><strong>Senior Game Advisor <br />GameStop - </strong> Elk River, MN</h2>
                ...
                <div>
                    <ul>
                        <h2><strong>Instructional Technology Student Employee <br />NDSCS Instructional Technology</strong> - Wahpeton, ND</h2>
                        <em>Nov. 2018 - May 2020</em>
                        <li>Worked on digitizing content for NDSCS's John Deere Program</li>
                        <li>Performed classroom installs and hardware troubleshooting</li>
                        <li>Administrative duties with school library</li>
                    </ul>
                </div>
            </div>
        </div>
